...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            <td>PPN ({{ $setting->ppn }}%):</td>
            <td class="text-right">{{ format_uang($penjualan->total_harga * ($setting->ppn / 100)) }}</td>
        </tr>
        <tr>
            <td>Margin ({{ $setting->margin }}%):</td>
            <td class="text-right">{{ format_uang($penjualan->total_harga * ($setting->margin / 100)) }}</td>
        </tr>
        <tr>
            <td>Tuslah:</td>
            <td class="text-right">{{ format_uang($setting->tuslah) }}</td>
        </tr>
        <tr>
            <td>Embalase:</td>
            <td class="text-right">{{ format_uang($setting->embalase) }}</td>
        </tr>
        <tr>
            <td>Total Bayar:</td>
